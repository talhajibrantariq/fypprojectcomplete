...
const {hospitalsignup ,hospitalsignin, hospitalsignout, doctorsignin, doctorsignout, signup ,signin, signout}= require('../controller/auht');
var { patientById } = require('../controller/patient');
var {doctorById} = require('../controller/doctor');
const {hospitalSignUpValidation, patientSignUpValidation, doctorSignUpValidation} = require('../validator/index');
