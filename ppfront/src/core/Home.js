              ...
              <div className="home-deck-card">
                <Link to={"/superadmin/superadminsignin"}>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>
                      Welcome admin. Sign in and register the hospitals.{" "}
                    </Card.Text>
              ...
              <div className="home-deck-card">
                <Link to={"/hospital/signin"}>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>
                      Hello hospital's admin. Register yourself with our
                      software, or login using the given credentials.
                    </Card.Text>
                    <span class="btn btn-raised btn-primary ">
                      Hospital's Portal
                    </span>
              ...
              <div className="home-deck-card">
                <Link to={"/doctor/signin"}>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>
                      Hello Doctor. Sign in to your account to interact with
                      your fellow doctors and manage your patients.{" "}
                    </Card.Text>
                    <span class="btn btn-raised btn-primary ">
                      Doctor's Portal
                    </span>
