...
import {getdoctor, deleteDoctor} from './hospitalapi';
            ...
            doctors.map((doctor, i)=>{
                return <div class="card col-md-4" style={{marginRight: 10, marginTop: 10}} key={i}>
                    <div class="card-body">
                        ...
                        <p class="card-text">Age: {doctor.age} years.</p>
                        ...
                        <Button type="danger" size="large" ghost onClick={() => this.deleteConfirmed(doctor._id)}>Delete</Button>
