  ...
  return (
    <div>
      <Switch>
          ...
          <DoctorRouter exact path='/doctor/dashboard' component={DoctorDashboard} />
          <DoctorRouter exact path="/doctor/edit/:doctorId" component={EditDoctor}/>
          <DoctorRouter exact path="/doctor/profile/:doctorId" component={DoctorProfile}/>
          ...
          <PrivateRouter exact path="/patient/edit/:patientId" component={EditPatient}/>
          ...
          <PrivateRouter exact path="/appointment/create" component={NewAppointment}/>
      </Switch>
    </div>
  );
}
