...
class EditDoctor extends Component {
    ...
    isValid = () => {
        const { firstname, lastname, phone, designation, email, fileSize } = this.state
        if (fileSize > 1000000) {
            this.setState({
    ...
    render() {
        const { id, firstname, lastname, age, phone, designation, email, redirectToProfile, error, loading } = this.state;
        if (redirectToProfile) {
            return <Redirect to={`/doctor/dashboard/profile/${id}`} />
        }
        const photoUrl = id ? `http://localhost:8080/doctor/photo/${id}` : DefaultProfile;
        return (
            <div>
                <div class="row mt-5">
                        ...
                        <div class="card card-body">
                            ...
                            <form action="/signup" method="POST">
                                <div class="form-group">
                                    ...
                                    <label className="text-muted" for="photo">Profile Photo</label>
                                    <input
                                ...
                                <div class="form-group">
                                    <label className="text-muted" for="age">Designation</label>
                                    <input
